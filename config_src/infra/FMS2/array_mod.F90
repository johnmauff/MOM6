...
!< This subroutine writes a LogicalArray_t variable to a binary file. Mirrors write_binary
!! (RealArray_t) exactly, but for a logical payload.
...
!< This subroutine reads a LogicalArray_t variable from a binary file. Mirrors read_binary
!! (RealArray_t) exactly, but for a logical payload.
